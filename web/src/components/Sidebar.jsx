...
//       <div style={{
//         position: 'absolute', top: 0, left: 0, right: 0, height: 180,
//         background: 'radial-gradient(ellipse at 50% -20%, rgba(255,255,255,0.05) 0%, transparent 70%)',
//         pointerEvents: 'none',
//       }} />
...
//             flexShrink: 0,
//           }}>
//             <img src="/logo.png" alt="Logo" style={{ width: '105%', height: '105%', objectFit: 'contain' }} />
//           </div>
//           <div>
//             <div style={{
//               fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '1.125rem',
...
const navGroups = {
  admin: [
    ...
    { label: 'Activity', items: [
      ...
      { to: '/videos',     icon: Play,              label: 'Videos' },
      { to: '/tests',      icon: ClipboardList,     label: 'Tests', badge: 'New' },
      { to: '/meetings',   icon: Video,             label: 'Meetings', badge: 'New' },
    ]},
    { label: 'Settings', items: [
      { to: '/work-schedule', icon: Settings, label: 'Work Schedule' },
    ]},
